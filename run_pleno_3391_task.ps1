...
$downloadDir = Join-Path $scriptDir 'planilhas_PLENO_3391_2025'
...
$args = @(
    ...
    '--de', '01/11/2025',
    '--ate', '30/11/2025',
    '--download-dir', '.\planilhas_PLENO_3391_2025',
    '--output-dir', '.\output',
    '--nome-docx', 'PAUTA_PLENO_3391_2025.docx',
    '--meta-tipo', 'ordinaria',
    ...
    '--send-email',
    '--email-to', $to,
    '--email-subject', 'Pauta Pleno 3391 - Automatica',
    '--email-force-sync',
    '--email-verbose'
)
