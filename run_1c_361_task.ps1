...
$downloadDir = Join-Path $scriptDir 'planilhas_1C_361_2025'
...
$args = @(
    ...
    '--de', '01/04/2025',
    '--ate', '30/04/2025',
    '--download-dir', '.\planilhas_1C_361_2025',
    '--output-dir', '.\output',
    '--nome-docx', 'PAUTA_1C_361_2025.docx',
    '--meta-tipo', 'ordinaria',
    ...
    '--send-email',
    '--email-to', $to,
    '--email-subject', 'Pauta 1a Camara 361 - Automatica',
    '--email-force-sync',
    '--email-verbose'
)
